...
const parseDate = (dateString) => {
    ...
    const lessThenXDaysAgo = (date, x) => Date.now() - 1000 * 60 * 60 * 24 * x < date.getTime();
...
// Singular, Plural
const numifyNoun = (number, singularForm, pluralForm) => {
    if (number == 1) {
...
// Capitalise
const captitalise = (string) => string.substring(0, 1).toUpperCase() + string.substring(1);
// Get file extension
