...
const initTinyMCE = () => {
	tinymce.init({
		selector: 'textarea',
		plugins: 'advlist autolink link image lists charmap preview anchor pagebreak searchreplace wordcoun     t visualblocks visualchars code fullscreen insertdatetime media nonbreaking table emoticons help',
...
const filePicker: FilePickerOverload = (
	...
	${ options.extensions == null ? '' : /* html */ `<p>Allowed extensions: ${ Array.from(options.extensions).join(', ') }</p>` }
	` : '' }
